package com.example.travelator._14accumulatedobjecttoconverter.v6;

import java.util.Objects;

public class Location {
	private final com.example.travelator._14accumulatedobjecttoconverter.v6.Id<Location> id;
	private final String localName;
	private final String userReadableName;
	
	public Location(com.example.travelator._14accumulatedobjecttoconverter.v6.Id<Location> id, String localName, String userReadableName) {
		this.id = id;
